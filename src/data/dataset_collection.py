...
class SyntheticDatasetCollection:
    ...
    def process_data_multi(self):
        ...
        # the last line process data and save to self.data, the next line put the self.data to self.data_processed_seq and revert the self.data to the original data
...
class SyntheticDatasetCollection_Simplified:
    """
    Dataset collection (train_f, val_f, test_cf_treatment_seq)
    """
    ...
    def process_data_simple(self):
        ...
        if hasattr(self, 'val_f') and self.val_f is not None:
            self.val_f.process_data(self.train_scaling_params)
        self.test_cf_treatment_seq.process_data(self.train_scaling_params)
        # self.test_cf_treatment_seq_gt_capo.process_data(self.train_scaling_params)
